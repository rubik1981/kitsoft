...
drop function if exists fnCalculateHash;
go
...
drop function if exists usp_Check;
go
...
drop procedure if exists calculate_and_save_one;
go
...
drop procedure if exists usp_init; 
go
